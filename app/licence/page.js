        ...
        <main className="min-h-screen bg-white">
            <div className="max-w-3xl mx-auto px-4 py-16 md:py-24">
                ...
                <section className="mb-12">
                    <h2 className="text-xl font-bold text-gray-900 mb-5">Vous pouvez</h2>
                ...
                <section className="mb-12">
                    <h2 className="text-xl font-bold text-gray-900 mb-5">Vous ne pouvez pas</h2>
                    <ul className="space-y-3">
                        {FORBIDDEN.map((item) => (
                            <li key={item} className="flex gap-3 text-gray-700 leading-relaxed">
                ...
                <section className="mb-12 p-6 bg-amber-50 border border-amber-100 rounded-2xl">
                ...
                <section className="mb-12">
                    ...
                    <div className="space-y-4 text-gray-700 leading-relaxed">
                        <p>
                            <strong className="text-gray-900">Vous restez propriétaire de vos images.</strong>{" "}
                        ...
                        <p>
                            <strong className="text-gray-900">Vous pouvez retirer une image à tout moment.</strong>{" "}
                        ...
                        <p>
                            <strong className="text-gray-900">Ne publiez que ce qui vous appartient.</strong>{" "}
                ...
                <section className="mb-12">
                    <h2 className="text-xl font-bold text-gray-900 mb-5">Créditer, si vous le souhaitez</h2>
                    ...
                    <pre className="p-4 bg-gray-50 border border-gray-100 rounded-xl text-sm text-gray-600 overflow-x-auto">
