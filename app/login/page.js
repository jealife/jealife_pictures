...
export default function LoginPage() {
    ...
    const handleEmailLogin = async (e) => {
        ...
        if (result.success) {
            ...
            setError(result.error || "Erreur de connexion. Vérifiez vos identifiants.");
        }
            ...
            <div className="w-full lg:w-[60%] flex flex-col justify-center items-center px-4 sm:px-12 md:px-24 py-12 lg:py-0 overflow-y-auto">
                <div className="w-full max-w-[560px]">
                    <div className="text-center mb-10">
                        <h1 className="text-5xl font-bold text-[#111] mb-4">Connexion</h1>
                    ...
                    <form onSubmit={handleEmailLogin} className="space-y-6">
                        <div>
                            <label className="block text-sm text-[#111] mb-1.5">Adresse Email</label>
                            <input
                                type="email"
                                value={email}
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-1.5">
                                <label className="block text-sm text-[#111]">Mot de passe</label>
                                <Link href="/forgot-password" className="text-sm text-[#767676] hover:text-[#111] underline transition-colors">Mot de passe oublié ?</Link>
                            </div>
