...
export default function ModerationPage() {
    ...
    return (
        <div className="space-y-16">
            <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-1">En attente de publication</h2>
                ...
                {pending === null ? (
                    ...
                    <p className="text-sm text-gray-400 italic">Rien en attente.</p>
                ) : (
                            ...
                            return (
                                <div key={item.id} className="flex items-center gap-4 p-3 border border-gray-100 rounded-xl">
                                    ...
                                    <button
                                        ...
                                        className="px-3 py-2 bg-black text-white text-xs font-bold rounded-lg hover:bg-gray-800 disabled:opacity-50 flex items-center gap-1.5"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="px-3 py-2 border border-gray-200 text-gray-600 text-xs font-bold rounded-lg hover:border-red-300 hover:text-red-600 disabled:opacity-50 flex items-center gap-1.5"
                                    >
            ...
            <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-1">Signalements ouverts</h2>
                <p className="text-gray-500 text-sm mb-6">
                ...
                {reports === null ? (
                    ...
                    <p className="text-sm text-gray-400 italic">Aucun signalement en attente.</p>
                ) : (
                    <div className="space-y-3">
                        {reports.filter((r) => r.media).map((report) => {
                            const key = `report-${report.id}`;
                            return (
                                <div key={report.id} className="flex items-start gap-4 p-3 border border-gray-100 rounded-xl">
                                    <Image
                                    ...
                                    <div className="min-w-0 flex-1">
                                        ...
                                        {report.details && (
                                            <p className="text-xs text-gray-600 italic">« {report.details} »</p>
                                        )}
                                    </div>
                                    <Link
                                    ...
                                    <button
                                        ...
                                        className="px-3 py-2 border border-gray-200 text-gray-600 text-xs font-bold rounded-lg hover:border-gray-400 disabled:opacity-50"
                                    >
                                        Ignorer
                                    </button>
                                    <button
