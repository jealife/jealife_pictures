    ...
    return (
        <div>
            ...
            <p className="text-gray-500 text-sm mb-10">
                ...
                . <Link href="/admin/settings" className="underline hover:text-black">Modifier</Link>
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {cards.map(({ label, value, href, icon: Icon }) => (
                    <Link
                        key={label}
                        href={href}
                        className="p-6 border border-gray-100 rounded-2xl hover:border-gray-300 transition-colors"
                    >
