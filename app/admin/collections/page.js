    ...
    return (
        <div>
            ...
            <section className="mt-16">
                <h2 className="text-2xl font-bold text-gray-900 mb-1">Collections de la communauté</h2>
                <p className="text-gray-500 text-sm mb-6">
                    Une collection publique avec au moins {MIN_PHOTOS_TO_SURFACE} photos apparaît
                    déjà seule sur <Link href="/collections" className="underline hover:text-black">/collections</Link>.
                ...
                {community === null ? (
                    ...
                    <p className="text-sm text-gray-400 italic">Aucune collection publique de la communauté pour l&apos;instant.</p>
                ) : (
                    <div className="space-y-2">
                        {community.map((collection) => {
                            ...
                            return (
                                <div key={collection.id} className="flex items-center gap-4 p-3 border border-gray-100 rounded-xl">
                                    ...
                                    <div className="min-w-0 flex-1">
                                        <p className="font-semibold text-gray-900 truncate">{collection.title}</p>
                                        <p className="text-xs text-gray-500 flex items-center gap-2">
                                            ...
                                            {qualifiesAutomatically && (
                                                <span className="text-emerald-600">· visible automatiquement</span>
                                            )}
                                        </p>
                                    </div>
                                    <button
