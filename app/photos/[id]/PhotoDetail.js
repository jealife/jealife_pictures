...
export default function PhotoDetail() {
    ...
    const copyThanks = async () => {
        ...
        const authorUrl = `https://stock.jealife.com/users/${photo.author.username}?utm_source=jealife_stock&utm_medium=referral&utm_content=creditCopyText`;
        const photoUrl = `https://stock.jealife.com/photos/${rawId}?utm_source=jealife_stock&utm_medium=referral&utm_content=creditCopyText`;
        
        const plainText = `Photo de ${photo.author.name} sur JEaLiFe Stock`;
        const htmlText = `Photo de <a href="${authorUrl}">${photo.author.name}</a> sur <a href="${photoUrl}">JEaLiFe Stock</a>`;
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="sticky top-0 sm:top-16 z-30 bg-white px-4 h-[72px] flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
                    ...
                    <DownloadButton media={photo} variant="primary" onDownloaded={() => setShowThanks(true)} />
                </div>
            </div>
...
function ThanksModal({ photo, copied, onCopy, onClose, onShare }) {
    return (
            ...
            >
                ...
                <div className="p-6 sm:p-8 flex-1 flex flex-col justify-center">
                    ...
                    <div className="flex items-center gap-2 mb-6">
                        <button onClick={onShare} className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 hover:bg-gray-50 hover:text-gray-900 transition-colors" aria-label="Partager">
